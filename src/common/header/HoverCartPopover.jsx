            ...
            {(popupState) => (
                <>
                    ...
                    <HoverPopover
                        ...
                        <Typography
                            component="div"
                            sx={{ maxHeight: '300px', p: 2, overflow: 'scroll' }}>
                        ...
                        <Box
                            ...
                            {Cart.totalCount !== 0 && (
                              <div style={{width: "100%", borderTop: "2px solid #cccccc8c"}}>
...
function MediaCard({ Item }) {
    ...
    return (
        <Card sx={{ maxWidth: 320, marginBottom: '1rem',boxShadow: "inset 0px 0px 0px 2px rgb(234 230 230 / 14%), 0px 1px 1px 0px rgba(0,0,0,0.14), 0px 1px 3px 0px rgba(0,0,0,0.12)" }}>
            ...
            <CardActions
                sx={{ display: 'flex', justifyContent: 'stretch', padding: '0' }}></CardActions>
        </Card>
    );
}
