...
const FavoriteProductCard = ({value,wishlistItemDetail,handleFavoriteClick}) => {
    console.log('object');
...
>
    ...
    <Button className="wishlist-card-body-btn"
     icon={
    !isRemoved ? (
        <HeartFilled
            style={{ color: 'red' }}
